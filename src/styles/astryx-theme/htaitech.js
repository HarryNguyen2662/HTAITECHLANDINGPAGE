...
/**
 * htaitech theme — built by `npx astryx theme build`
 * Import the CSS file alongside this module:
 *
 *   import { htaitechTheme } from './htaitech';
 *   import './htaitech.css';
 */
export const htaitechTheme = {
  name: 'htaitech',
  __built: true,
  tokens: {
    ...
    "--font-family-body": "var(--font-body), -apple-system, BlinkMacSystemFont, \"Segoe UI\", Roboto, Helvetica, Arial, sans-serif",
    "--font-family-heading": "var(--font-display), Georgia, \"Times New Roman\", serif",
    "--font-family-code": "var(--font-mono), \"SF Mono\", Monaco, Consolas, \"Liberation Mono\", \"Courier New\", monospace",
    ...
    "--color-background-body": "light-dark(#f7f5f0, #f7f5f0)",
    "--color-background-card": "light-dark(#f7f5f0, #f7f5f0)",
    "--color-background-popover": "light-dark(#ffffff, #ffffff)",
    "--color-background-muted": "light-dark(#efebe2, #efebe2)",
    "--color-accent": "light-dark(#c24d1e, #c24d1e)",
    "--color-accent-muted": "light-dark(#f3e7e2, #f3e7e2)",
    "--color-neutral": "light-dark(#0000000F, #0000000F)",
    "--color-overlay": "light-dark(#00000080, #00000080)",
    "--color-overlay-hover": "light-dark(#0000000D, #0000000D)",
    "--color-overlay-pressed": "light-dark(#0000001A, #0000001A)",
    "--color-text-primary": "light-dark(#14181c, #14181c)",
    "--color-text-secondary": "light-dark(#4a4f55, #4a4f55)",
    "--color-text-disabled": "light-dark(#a3a3a3, #a3a3a3)",
    "--color-text-accent": "light-dark(#c24d1e, #c24d1e)",
    "--color-on-dark": "#ffffff",
    "--color-on-light": "#14181c",
    "--color-on-accent": "light-dark(#f7f5f0, #f7f5f0)",
    "--color-on-success": "light-dark(#f7f5f0, #f7f5f0)",
    "--color-on-error": "light-dark(#f7f5f0, #f7f5f0)",
    "--color-on-warning": "#14181c",
    "--color-icon-accent": "light-dark(#c24d1e, #c24d1e)",
    "--color-icon-primary": "light-dark(#14181c, #14181c)",
    "--color-icon-secondary": "light-dark(#4a4f55, #4a4f55)",
    "--color-icon-disabled": "light-dark(#a3a3a3, #a3a3a3)",
    "--color-success": "light-dark(#1f6f54, #1f6f54)",
    "--color-error": "light-dark(#b12c25, #b12c25)",
    "--color-warning": "light-dark(#745b00, #745b00)",
    "--color-success-muted": "light-dark(#dceae4, #dceae4)",
    "--color-error-muted": "light-dark(#f5dcda, #f5dcda)",
    "--color-warning-muted": "light-dark(#f8da9d, #f8da9d)",
    "--color-border": "light-dark(#dfdad0, #dfdad0)",
    "--color-border-emphasized": "light-dark(#c7bda6, #c7bda6)",
    "--color-skeleton": "light-dark(#efebe2, #efebe2)",
    "--color-shadow": "light-dark(#0000001A, #0000001A)",
    "--color-tint-hover": "light-dark(black, black)",
