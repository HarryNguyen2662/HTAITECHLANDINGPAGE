...
export const neutralTheme = defineTheme({
  ...
  // Typography: bound to the next/font variables set on <html> in the root
  // layout (src/libs/fonts.ts) so Astryx components share the same
  // Fraunces / IBM Plex Sans / IBM Plex Mono stack as the hand-rolled UI.
  ...
  tokens: {
    ...
    // =========================================================================
    // H&T token system — ink / paper / signal, see .claude/CLAUDE.md and the
    // UI Redesign Directive. Mode is locked to 'light' on <Theme>, so the
    // dark slot is only a safety fallback and mirrors the light value.
    '--color-background-surface': ['#ffffff', '#ffffff'],
    '--color-background-body': ['#f7f5f0', '#f7f5f0'],
    '--color-background-card': ['#f7f5f0', '#f7f5f0'],
    '--color-background-popover': ['#ffffff', '#ffffff'],
    '--color-background-muted': ['#efebe2', '#efebe2'],

    // Accent + neutral surface tints (sit alongside backgrounds)
    '--color-accent': ['#c24d1e', '#c24d1e'],
    '--color-accent-muted': ['#f3e7e2', '#f3e7e2'],
    '--color-neutral': ['#0000000F', '#0000000F'],

    // Overlays (modal scrims, hover/pressed tints)
    '--color-overlay': ['#00000080', '#00000080'],
    '--color-overlay-hover': ['#0000000D', '#0000000D'],
    '--color-overlay-pressed': ['#0000001A', '#0000001A'],

    // Text
    '--color-text-primary': ['#14181c', '#14181c'],
    '--color-text-secondary': ['#4a4f55', '#4a4f55'],
    '--color-text-disabled': ['#a3a3a3', '#a3a3a3'],
    '--color-text-accent': ['#c24d1e', '#c24d1e'],
    '--color-on-dark': '#ffffff',
    '--color-on-light': '#14181c',
    // Contrast: paper text sits on the signal-colored accent fill
    '--color-on-accent': ['#f7f5f0', '#f7f5f0'],
    '--color-on-success': ['#f7f5f0', '#f7f5f0'],
    '--color-on-error': ['#f7f5f0', '#f7f5f0'],
    '--color-on-warning': '#14181c',

    // Icon
    '--color-icon-accent': ['#c24d1e', '#c24d1e'],
    '--color-icon-primary': ['#14181c', '#14181c'],
    '--color-icon-secondary': ['#4a4f55', '#4a4f55'],
    '--color-icon-disabled': ['#a3a3a3', '#a3a3a3'],
    ...
    // "Success" maps to the brand's verify teal-green — same "checked,
    // trustworthy" meaning the exam/CV product copy uses elsewhere.
    '--color-success': ['#1f6f54', '#1f6f54'],
    '--color-error': ['#b12c25', '#b12c25'],
    '--color-warning': ['#745b00', '#745b00'],
    '--color-success-muted': ['#dceae4', '#dceae4'],
    '--color-error-muted': ['#f5dcda', '#f5dcda'],
    '--color-warning-muted': ['#f8da9d', '#f8da9d'],

    // Border
    '--color-border': ['#dfdad0', '#dfdad0'],
    '--color-border-emphasized': ['#c7bda6', '#c7bda6'],

    // Effects
    '--color-skeleton': ['#efebe2', '#efebe2'],
    '--color-shadow': ['#0000001A', '#0000001A'],
    ...
    // =========================================================================
    // Sharp, architectural corners to match the exam/documentation motif —
    // see .claude/CLAUDE.md and tailwind.config.ts (--radius: 0.25rem).
    '--radius-none': '0',
